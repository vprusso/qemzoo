...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    html += editEntryHtml("data/techniques.json", `data/techniques/${id}.json`);
...
async function renderNoiseScalingDetail(id, content, breadcrumbName, breadcrumb, cacheBust) {
  try {
    ...
    html += editEntryHtml("data/noise-scaling.json", `data/noise-scaling/${id}.json`);
...
async function renderNoiseDetail(id, content, breadcrumbName, breadcrumb, cacheBust) {
  try {
    ...
    html += editEntryHtml("data/noise.json", `data/noise/${id}.json`);
...
async function renderExtrapolationDetail(id, content, breadcrumbName, breadcrumb, cacheBust) {
  try {
    ...
    html += editEntryHtml("data/extrapolation.json", `data/extrapolation/${id}.json`);
...
async function renderNoiseLearningDetail(id, content, breadcrumbName, breadcrumb, cacheBust) {
  try {
    ...
    html += editEntryHtml("data/noise-learning.json", `data/noise-learning/${id}.json`);
